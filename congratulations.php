...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['action'] === 'resetProgress') {
    ...
    $stmt->execute();
    header("Location: index.php"); // Redirect to the question page
    exit;
}
...
if (!$noMoreQuestions) {
    header("Location: index.php"); // Redirect back if there are still available questions
    exit;
}
?>
                ...
                <div class="row h-100">
                    <div class="col-md-10 col-xl-8 d-flex d-sm-flex d-md-flex justify-content-center align-items-center mx-auto justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div>
                            ...
                            <p class="mb-5">—&nbsp;<a class="fw-bold text-decoration-none" href="credits.html">The PhilNITS FE Review Team</a></p>
